...
/**
 * JPA entity for storing audit trail of product attribute changes.
 * Tracks all INSERT, UPDATE, and DELETE operations on product attributes.
 */
@Entity
@Table(name = "attribute_audit")
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class InfrastructureAttributeAuditJpaEntity {
    ...
    /**
     * Creates an audit record for attribute insertion
     * @param attributeId the attribute ID
     * @param afterState the state after creation
     * @param changedBy the user who created the attribute
     * @return audit entity for insertion
     */
    public static InfrastructureAttributeAuditJpaEntity forInsert(UUID attributeId, String afterState, String changedBy) {
    ...
    /**
     * Creates an audit record for attribute update
     * @param attributeId the attribute ID
     * @param beforeState the state before update
     * @param afterState the state after update
     * @param changedBy the user who updated the attribute
     * @return audit entity for update
     */
    public static InfrastructureAttributeAuditJpaEntity forUpdate(UUID attributeId, String beforeState, String afterState, String changedBy) {
        return InfrastructureAttributeAuditJpaEntity.builder()
                .attributeId(attributeId)
    ...
    /**
     * Creates an audit record for attribute deletion
     * @param attributeId the attribute ID
     * @param beforeState the state before deletion
     * @param changedBy the user who deleted the attribute
     * @return audit entity for deletion
     */
    public static InfrastructureAttributeAuditJpaEntity forDelete(UUID attributeId, String beforeState, String changedBy) {
        return InfrastructureAttributeAuditJpaEntity.builder()
                .attributeId(attributeId)
